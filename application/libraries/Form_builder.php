...
class Form_Builder {
	...
	public function assign_vars($form_structure, $form_values, $cond){
		...
		if(gettype($form_structure) == "string") {
            $this->form_structure = $this->get_form_structure($tablename);
        }

		$this->form_values = $form_values;
		if(gettype($form_values) == "string") {$this->form_values = $this->get_form_values($tablename, $id, $cond);}
...
////////////////////*/
	...
	public function get_form_values($tablename = '', $id = '', $cond = '') {
